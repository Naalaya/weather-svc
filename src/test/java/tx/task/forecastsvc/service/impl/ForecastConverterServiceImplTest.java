...
class ForecastConverterServiceImplTest {
    ...
    void testConvertToRecord() {
        ...
        when(mockResponse.getWeather()).thenReturn(List.of(
                ForecastResponse.Weather.builder()
                        .id(803)
                        .main("Clouds")
                        .description("mây cụm")
                        .build()
        ));
        when(mockResponse.getMain()).thenReturn(ForecastResponse.Main.builder()
                .temp(25.0)
                .temp_min(25.0)
                .temp_max(25.0)
                .humidity(73)
                .pressure(1017)
                .build());
        when(mockResponse.getWind()).thenReturn(ForecastResponse.Wind.builder()
                .speed(5.06)
                .deg(9)
                .gust(6.56)
                .build());
        when(mockResponse.getClouds()).thenReturn(ForecastResponse.Clouds.builder()
                .all(81)
                .build());
        when(mockResponse.getSys()).thenReturn(ForecastResponse.Sys.builder()
